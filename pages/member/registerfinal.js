    ...
    <div className={styles.profile}>
      ...
      <div className={styles.signupcard}>
        ...
        <div className={styles.div3}>
          <button type="button" className={styles.registerchild}>會員註冊</button>
        </div>
        ...
        <div className={styles.registergroup1}>
          ...
          <Link href="login" className={styles.b3}>回會員登入</Link>
            {/* <b className={styles.b3}>回會員登入</b> */}
          </div>
        </div>
        <div className={styles.register}>
        <div className={styles.inputGroup}>
            <label className={styles.div600}>姓名</label>
            <input type="text" className={styles.input} placeholder="請輸入姓名" />
          ...
          <div className={styles.div12}>
            <label className={styles.div13}>電話號碼</label>
            <input
              type="tel"
          ...
          <div className={styles.div14}>  
            <div className={styles.div15}>
              <div className={styles.div16}>
               ...
               <label className={styles.div13}>電子信箱</label>
                  <input
              type="email"
              className={styles.input}
              placeholder="請輸入電子信箱" 
            />
              ...
              <div className={styles.div18}>
                <label className={styles.div13}>密碼</label>
                <input
      ...
      >
        {showNewPass ? '顯示': '不顯示'}
            ...
            <div className={styles.div20}>
              <label className={styles.div13}>確認密碼</label>
              <input
